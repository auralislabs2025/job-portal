    ...
    <div class="card" style="max-width:800px;">
        <form method="POST" action="{{ route('jobs.update', $job) }}" id="editJobForm">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="6" required placeholder="Describe the role, responsibilities, qualifications, and requirements...">{{ old('description', $job->description) }}</textarea>
